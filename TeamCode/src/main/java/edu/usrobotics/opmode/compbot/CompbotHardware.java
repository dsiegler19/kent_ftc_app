...
public class CompbotHardware extends BaseHardware {
    ...
    public ColorSensor buttonPresserColorSensorLeft;
    ...
    public void getDevices() {
        ...
        buttonPresserColorSensorLeft = hardwareMap.colorSensor.get("csl");
        buttonPresserColorSensorLeft.setI2cAddress(I2cAddr.create7bit(0x26));
        buttonPresserColorSensorLeft.enableLed(false);
        ...
        buttonPresserColorSensorRight.enableLed(false);

        gyroSensor = (ModernRoboticsI2cGyro) hardwareMap.gyroSensor.get("gyro");
        gyroSensor.setI2cAddress(I2cAddr.create7bit(0x1e));
    ...
    public boolean straight(){
        ...
        return gyroSensor.getHeading() >= 357 || gyroSensor.getHeading() <= 3;
